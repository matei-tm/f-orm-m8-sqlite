...
mixin ${emittedEntity.modelName}DatabaseHelper /*implements AbstractDatabaseHelper*/ {
  ...
  final the${emittedEntity.modelName}Columns = ["id", "record_date", "is_deleted" /*, "entry_name"*/];

  final String ${theTableHandler} = '${theTableHandlerValue}';

  Future create${emittedEntity.modelName}Table(Database db) async {
await db.execute(
    'CREATE TABLE \$${theTableHandler} (\$columnId INTEGER PRIMARY KEY, record_date INTEGER, is_deleted INTEGER )');
  }
